...
1. To test the first hypothesis that states and counties have partisan shifts (which can impact the accuracy of my model), I can look at recent voting trends in such states and counties. 
    ...
    * We can thus analyze any trends using regressions and correlations and if we see any trends where certain states and counties are shifting blue or red, that is something to take note of. 
...
3. To test the third hypothesis, one test that can be used is create a predictive linear model for the popular vote share for a candidate only using recent polls. 
    * Given that historical polls may not be as predictive for today's elections, it may make sense to only use recent polls like from 2016 onward. This might be because there was never really a president with the character of Trump and so there may be **non-response bias** among republicans as some republicans may be afraid to alert pollsters that they will vote for Trump. 
...
I really enjoyed making my prediction model and learning from it. I now have a better grasp in making predictive models and I am eager to see how future elections will differ from the 2020 election and use my skills in the future. I want to thank my teaching fellow for Gov 1347, Sun Young Park, as well as Professor Ryan D. Enos and Soubhik Barari, for their teaching and help throughout the semester.
